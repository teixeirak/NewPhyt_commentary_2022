...
Needed is an understanding of how woody growth is jointly shaped by photosynthesis (i.e., source limitation) and demand from various C sinks (i.e., sink limitation) across species and biomes [@korner_paradigm_2015]. 
In this issue of *New Phytologist*, Martinez-Sancho *et al.* (pp. 000-000) exemplifies the type of research needed to improve our ability to predict forest C sequestration under climate change, using an innovative approach to describe the seasonal course of carbon sequestration in tree stem growth and how it is affected by drought.
...
*(GPP less affected?)[@kannenberg_droughtinduced_2022]*
...
….*GPP* is less senstiive to drought than *ANPP~woody~* [@kannenberg_droughtinduced_2022].
...[@dow_warm_inpress]
...[@jiang_fate_2020]
