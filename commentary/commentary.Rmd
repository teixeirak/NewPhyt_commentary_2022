...
In this issue of *New Phytologist*, Martinez-Sancho *et al.* (pp. 000-000) use an innovative approach to describe the seasonal course of carbon sequestration in tree stem growth and how this is affected by drought.
This study exemplifies the type of research needed to improve our ability to predict forest C sequestration under climate change. 

*(1-2 paragraphs summarizing/ explaining Martinez-Sancho study)*
