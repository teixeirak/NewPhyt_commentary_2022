...
| | count |
|--|--|
|words|  1608 *(1500 max)* | <!--1200– 1500 words (~6-10 par) -->
...
![**Figure 2. Schematic summarizing the relationship between photosynthesis and wood formation across various time scales.** Red wedges indicate integration across time and space. *DRAFT FIGURE. I'm thinking of watercolor paintings of the trees, scanned images of a core and annual rings.*](display/figure2_draft.png)
